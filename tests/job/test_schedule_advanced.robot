...
test_cron_false
    ...
    ...    ${script}
    ...    CREATE JOB NEW_JOB_1 '59 23 11 2 3' ACTIVE START DATE NULL END DATE NULL AS begin /*job is here*/ end
...
test_cron_true
    ...
    Should Be Equal As Strings
    ...    ${script}
    ...    CREATE JOB NEW_JOB_1 '12-58 12-23 13-31 3-10 2-6' ACTIVE START DATE NULL END DATE NULL AS begin /*job is here*/ end
    ...    collapse_spaces=${True}
