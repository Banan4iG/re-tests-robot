...
test_check_node
    ...
    ...    ${script}
    ...    CREATE TABLE COUNTRY ( COUNTRY COUNTRYNAME NOT NULL, CURRENCY VARCHAR(10) NOT NULL, CONSTRAINT INTEG_2 PRIMARY KEY (COUNTRY) USING ASCENDING INDEX RDB$PRIMARY1);
    ...    strip_spaces=${True}
