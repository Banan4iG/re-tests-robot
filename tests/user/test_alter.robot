...
test_edit_name
    ...
    Check
    ...    ALTER USER TEST_USER USING PLUGIN Srp FIRSTNAME '${TEST_NEW_USER_FIRST_NAME}' MIDDLENAME '${TEST_NEW_USER_MIDDLE_NAME}' LASTNAME '${TEST_NEW_USER_LAST_NAME}'
    Sleep    1s
...
test_append_tags_to_precreated_user_tags
    Execute Immediate
    ...    CREATE USER ${TEST_USERNAME} PASSWORD '${TEST_USER_PASSWORD}' ACTIVE USING PLUGIN Srp TAGS (CARD = '123', PC = '999')
    ...
    ...    ${sorted_final}
    ...    [['ADDED1', 'val1'], ['ADDED2', 'val2'], ['CARD', '123'], ['PC', '999']]
...
test_user_ddl_after_modification
    ...
    Should Be Equal As Strings
    ...    ${ddl}
    ...    CREATE USER TEST_USER ACTIVE USING PLUGIN Srp TAGS (EXAMPLE_TAG = 'value123' ); COMMENT ON USER TEST_USER USING PLUGIN Srp IS 'test_comment';
    ...    strip_spaces=${True}
