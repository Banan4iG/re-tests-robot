...
test_create_inactive_with_info
    ...
    ...    ${sql}
    ...    CREATE USER "TEST USER" FIRSTNAME 'first' MIDDLENAME 'mid dle' LASTNAME 'last_name' PASSWORD '123' INACTIVE USING PLUGIN Srp;
    ...    strip_spaces=${True}
...
Check
    ...
    ...    org.netbeans.jemmy.TimeoutExpiredException: Dialog with name or title 'Create user'
    ...    Select Dialog
    ...    Create user
    Select Main Window
