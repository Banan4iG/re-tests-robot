...
test_1
    ...
    IF    ${{$ver == '5' and $srv_ver == 'RedDatabase'}}
        ...
        IF    ${{$connect_type == 'embedded'}}
            ...
            ...    ${tree1}
            ...    ['Domains', 'Tables', 'Global Temporary Tables', 'Views', 'Procedures (1)', 'Functions', 'Packages', 'Table Triggers', 'DDL Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Roles', 'Indices']
            Should Be Equal As Strings
            ...    ${tree2}
            ...    ['Domains', 'Tables (1)', 'Global Temporary Tables', 'Views', 'Procedures', 'Functions', 'Packages', 'Table Triggers', 'DDL Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Roles', 'Indices']
        ELSE
            Should Be Equal As Strings
            ...    ${tree1}
            ...
            Should Be Equal As Strings
            ...    ${tree2}
            ...    ['Domains', 'Tables (1)', 'Global Temporary Tables', 'Views', 'Procedures', 'Functions', 'Packages', 'Table Triggers', 'DDL Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Users', 'Roles', 'Indices', 'Tablespaces', 'Jobs']
        END
    ELSE IF    ${{$ver == '2.6'}}
        Should Be Equal As Strings
        ...    ${tree1}
        ...
        Should Be Equal As Strings
        ...    ${tree2}
        ...    ['Domains', 'Tables (1)', 'Global Temporary Tables', 'Views', 'Procedures', 'Table Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Roles', 'Indices']
    ELSE
        Should Be Equal As Strings
        ...    ${tree1}
        ...
        Should Be Equal As Strings
        ...    ${tree2}
        ...    ['Domains', 'Tables (1)', 'Global Temporary Tables', 'Views', 'Procedures', 'Functions', 'Packages', 'Table Triggers', 'DDL Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Users', 'Roles', 'Indices']
    END
