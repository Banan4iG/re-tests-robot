...
test_1
    ...
    IF    ${{$ver == '5' and $srv_ver == 'RedDatabase'}}
        ...
        IF    ${{$connect_type == 'embedded'}}
            ...
            Should Be Equal As Strings
            ...    ${tree2}
            ...    ['Domains', 'Tables (1)', 'Global Temporary Tables', 'Views', 'Procedures', 'Functions', 'Packages', 'Table Triggers', 'DDL Triggers', 'DB Triggers', 'Sequences', 'Exceptions', 'UDFs', 'Roles', 'Indices', 'Tablespaces']
        ELSE
            Should Be Equal As Strings
            ...    ${tree1}
