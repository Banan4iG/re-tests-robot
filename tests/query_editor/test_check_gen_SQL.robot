...
test_2
    ...
    ${ver}=     Set Variable    ${info}[1]
    IF  ${{$ver == '5.0'}}
        action_INCREMENT_FIELDS    INSERT    INSERT INTO INCREMENT_FIELDS ( DEFAULT_IDENTITY_C, ALWAYS_IDENTITY_C, SEQUENCE_C, SEQUENCE_C_2, COMPUTED_C ) VALUES ( DEFAULT, :ALWAYS_IDENTITY_C, :SEQUENCE_C, :SEQUENCE_C_2, DEFAULT );
    ELSE
...
test_3
    ...
    ${ver}=     Set Variable    ${info}[1]
    IF  ${{$ver == '5.0'}}
        action_INCREMENT_FIELDS    UPDATE    UPDATE INCREMENT_FIELDS SET DEFAULT_IDENTITY_C = DEFAULT, ALWAYS_IDENTITY_C = :ALWAYS_IDENTITY_C, SEQUENCE_C = :SEQUENCE_C, SEQUENCE_C_2 = :SEQUENCE_C_2, COMPUTED_C = DEFAULT;
    ELSE
...
test_4
    ...
    ${ver}=     Set Variable    ${info}[1]
    IF  ${{$ver == '5.0'}}
        action_INCREMENT_FIELDS    CREATE    CREATE TABLE INCREMENT_FIELDS ( DEFAULT_IDENTITY_C BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, ALWAYS_IDENTITY_C BIGINT NOT NULL, SEQUENCE_C SMALLINT, SEQUENCE_C_2 BIGINT NOT NULL, COMPUTED_C COMPUTED BY ( 0 + 1));
    ELSE
        action_INCREMENT_FIELDS    CREATE    CREATE TABLE INCREMENT_FIELDS ( DEFAULT_IDENTITY_C BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, SEQUENCE_C SMALLINT, SEQUENCE_C_2 BIGINT NOT NULL, COMPUTED_C COMPUTED BY ( 0 + 1));
    END
...
test_8
    action_OTHER_TABLE    CREATE    CREATE TABLE OTHER_TABLE ( INCREMENT_C BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, COMPUTED_C COMPUTED BY ( 0 + 1));
