...
test_check_grant
    ...
    Should Be Equal As Strings
    ...    ${result}
    ...    [('D', 0, 'JOB '), ('I', 0, 'JOB '), ('R', 0, 'JOB '), ('S', 0, 'JOB '), ('U', 0, 'JOB ')]
    ...    strip_spaces=${true}
    ...    collapse_spaces=${true}
    ...
    Should Be Equal As Strings
    ...    ${result}
    ...    [('U', 0, 'COUNTRY '), ('U', 0, 'CUSTOMER '), ('U', 0, 'DEPARTMENT '), ('U', 0, 'EMPLOYEE '), ('U', 0, 'EMPLOYEE_PROJECT '), ('U', 0, 'JOB '), ('U', 0, 'PHONE_LIST '), ('U', 0, 'PROJECT '), ('U', 0, 'PROJ_DEPT_BUDGET '), ('U', 0, 'SALARY_HISTORY '), ('U', 0, 'SALES ')]
    ...    strip_spaces=${true}
    ...    collapse_spaces=${true}
    ...
    Should Be Equal As Strings
    ...    ${result}
    ...    [('U', 1, 'COUNTRY '), ('U', 1, 'CUSTOMER '), ('U', 1, 'DEPARTMENT '), ('U', 1, 'EMPLOYEE '), ('U', 1, 'EMPLOYEE_PROJECT '), ('D', 1, 'JOB '), ('I', 1, 'JOB '), ('R', 1, 'JOB '), ('S', 1, 'JOB '), ('U', 1, 'JOB '), ('U', 1, 'PHONE_LIST '), ('U', 1, 'PROJECT '), ('U', 1, 'PROJ_DEPT_BUDGET '), ('U', 1, 'SALARY_HISTORY '), ('U', 1, 'SALES ')]
    ...    strip_spaces=${true}
    ...    collapse_spaces=${true}
...
test_check_grant_column
    ...
    Should Be Equal As Strings
    ...    ${result}
    ...    [('U', 0, 'JOB_CODE '), ('U', 0, 'JOB_COUNTRY '), ('U', 0, 'JOB_GRADE '), ('U', 0, 'JOB_REQUIREMENT '), ('R', 0, 'JOB_TITLE '), ('U', 0, 'JOB_TITLE '), ('U', 0, 'LANGUAGE_REQ '), ('U', 0, 'MAX_SALARY '), ('U', 0, 'MIN_SALARY ')]
    ...    strip_spaces=${true}
    ...    collapse_spaces=${true}
    ...
    Should Be Equal As Strings
    ...    ${result}
    ...    [('U', 1, 'JOB_CODE '), ('U', 1, 'JOB_COUNTRY '), ('U', 1, 'JOB_GRADE '), ('U', 1, 'JOB_REQUIREMENT '), ('R', 1, 'JOB_TITLE '), ('U', 1, 'JOB_TITLE '), ('U', 1, 'LANGUAGE_REQ '), ('U', 1, 'MAX_SALARY '), ('U', 1, 'MIN_SALARY ')]
    ...    strip_spaces=${true}
    ...    collapse_spaces=${true}
...
Get DML Privileges
    ${result}=    Execute
    ...    SELECT CAST(RDB$PRIVILEGE as VARCHAR(1)), RDB$GRANT_OPTION, CAST(RDB$RELATION_NAME as VARCHAR(21)) FROM RDB$USER_PRIVILEGES WHERE RDB$USER='TEST_ROLE' ORDER BY RDB$RELATION_NAME, RDB$PRIVILEGE
    RETURN    ${result}

Get DML Privileges For Field
    ${result}=    Execute
    ...    SELECT CAST(RDB$PRIVILEGE as VARCHAR(1)), RDB$GRANT_OPTION, CAST(RDB$FIELD_NAME as VARCHAR(16)) FROM RDB$USER_PRIVILEGES WHERE RDB$USER='TEST_ROLE' ORDER BY RDB$FIELD_NAME, RDB$PRIVILEGE
    RETURN    ${result}
