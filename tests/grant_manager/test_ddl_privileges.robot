...
test_1
    ...
    ELSE
        ...
        VAR    ${expected_result_3}
        ...    [('L', 0, 'SQL$CHARSETS '), ('L', 0, 'SQL$COLLATIONS '), ('L', 0, 'SQL$DATABASE '), ('L', 0, 'SQL$DOMAINS '), ('L', 0, 'SQL$EXCEPTIONS '), ('L', 0, 'SQL$FILTERS '), ('L', 0, 'SQL$FUNCTIONS '), ('L', 0, 'SQL$GENERATORS '), ('L', 0, 'SQL$PACKAGES '), ('L', 0, 'SQL$PROCEDURES '), ('L', 0, 'SQL$ROLES '), ('L', 0, 'SQL$TABLES '), ('L', 0, 'SQL$VIEWS ')]

        VAR    ${expected_result_4}
        ...    [('L', 1, 'SQL$CHARSETS '), ('L', 1, 'SQL$COLLATIONS '), ('L', 1, 'SQL$DATABASE '), ('L', 1, 'SQL$DOMAINS '), ('L', 1, 'SQL$EXCEPTIONS '), ('L', 1, 'SQL$FILTERS '), ('L', 1, 'SQL$FUNCTIONS '), ('C', 1, 'SQL$GENERATORS '), ('L', 1, 'SQL$GENERATORS '), ('O', 1, 'SQL$GENERATORS '), ('L', 1, 'SQL$PACKAGES '), ('L', 1, 'SQL$PROCEDURES '), ('L', 1, 'SQL$ROLES '), ('L', 1, 'SQL$TABLES '), ('L', 1, 'SQL$VIEWS ')]
...
Get DDL Privileges
    ${result}    Execute
    ...    SELECT CAST(RDB$PRIVILEGE as VARCHAR(1)), RDB$GRANT_OPTION, CAST(RDB$RELATION_NAME as VARCHAR(20)) FROM RDB$USER_PRIVILEGES WHERE RDB$USER='TEST_ROLE' ORDER BY RDB$RELATION_NAME, RDB$PRIVILEGE
    RETURN    ${result}
