...
test_external_module
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE ON CONNECT POSITION 0 EXTERNAL NAME 'TestExternalMetod' ENGINE TestEngine
...
test_text_field_1
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE ON CONNECT POSITION 3 AS DECLARE tmp INTEGER; BEGIN SELECT COUNT(*) FROM SHOW_LANGS('ENG', 1, 'USA') INTO tmp; END
...
test_text_field_2
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE ON CONNECT POSITION 0 AS BEGIN -- Test comment for test END
