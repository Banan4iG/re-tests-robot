...
test_use_external_module
    ...
    Check
    ...    CREATE OR ALTER TRIGGER NEW_TRIGGER ACTIVE BEFORE ANY DDL STATEMENT POSITION 0 EXTERNAL NAME 'external_point' ENGINE external_engine
...
test_sql_security_definer
    ...
    Check Check Box    anyStatementCheck
    Check
    ...    CREATE OR ALTER TRIGGER NEW_TRIGGER ACTIVE BEFORE ANY DDL STATEMENT POSITION 0 SQL SECURITY DEFINER AS BEGIN /* Trigger impl */ END
