...
test_active
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER INACTIVE BEFORE CREATE FUNCTION POSITION 0 AS DECLARE tmp INTEGER; BEGIN SELECT COUNT(*) FROM SHOW_LANGS('ENG', 1, 'USA') INTO tmp; END

test_sql_security_1
    Init
    Select From Combo Box    userContextComboBox    DEFINER
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE BEFORE CREATE FUNCTION POSITION 0 SQL SECURITY DEFINER AS DECLARE tmp INTEGER; BEGIN SELECT COUNT(*) FROM SHOW_LANGS('ENG', 1, 'USA') INTO tmp; END

test_sql_security_2
    Init
    Select From Combo Box    userContextComboBox    INVOKER
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE BEFORE CREATE FUNCTION POSITION 0 SQL SECURITY INVOKER AS DECLARE tmp INTEGER; BEGIN SELECT COUNT(*) FROM SHOW_LANGS('ENG', 1, 'USA') INTO tmp; END
...
test_external_module
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE BEFORE CREATE FUNCTION POSITION 0 EXTERNAL NAME 'TestExternalMetod' ENGINE TestEngine
...
test_text_field_1
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE BEFORE CREATE FUNCTION POSITION 3 AS DECLARE tmp INTEGER; BEGIN SELECT COUNT(*) FROM SHOW_LANGS('ENG', 1, 'USA') INTO tmp; END
...
test_text_field_2
    ...
    Check Changes
    ...    CREATE OR ALTER TRIGGER TEST_TRIGGER ACTIVE BEFORE CREATE FUNCTION POSITION 0 AS BEGIN -- Test comment for test END
