...
test_CSV_export_to_folder
    ...
    ...    SEPARATOR=\n
    ...    Video Database;${blob_path1}
    ...    DigiPizza;${blob_path2}
    ...    AutoMap;${blob_path3}
    ...    ${EMPTY}
...
test_CSV_export_to_file
    ...
    ${expected_content}=    Catenate
    ...    SEPARATOR=\n
    ...    Video Database;:h00000000_00000059
    ...    DigiPizza;:h00000059_00000077
    ...    AutoMap;:h000000d0_00000055
    ...    ${EMPTY}
    File Should Exist    ${export_path}
    ${content}=    Get File    ${export_path}
    Should Be Equal As Strings    ${content}    ${expected_content}
...
test_XLSX_export_to_file
    ...
    Close Dialog    Message
    VAR    ${expected_content}=
    ...    None None Video Database :h00000000_00000059 DigiPizza :h00000059_00000077 AutoMap :h000000d0_00000055
    File Should Exist    ${export_path}
    ${content}=    Check Xlsx    ${export_path}
    Should Be Equal As Strings    ${content}    ${expected_content}    strip_spaces=${True}    collapse_spaces=${True}
