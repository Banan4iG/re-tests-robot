...
test_alter_package
    ...
    Check Comment    NEW_PACK    PACKAGE    RDB$PACKAGES

test_alter_sequence
    Init Alter    Sequences (2)|EMP_NO_GEN
    Select Tab As Context    EMP_NO_GEN:SEQUENCE:New Connection
...
test_alter_exception
    ...
    Check Comment    CUSTOMER_CHECK    EXCEPTION    RDB$EXCEPTIONS
...
test_alter_ts
    ...
    Check Comment    NEW_TS    TABLESPACE    RDB$TABLESPACES
...
test_alter_job
    ...
    Check Comment    NEW_JOB    JOB    RDB$JOBS
